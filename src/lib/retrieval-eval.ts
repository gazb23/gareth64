...
export const ragEvalCases = [
  ...
  { kind: "supported", id: "iris-clinical-use", category: "supported-question", question: "Has IRIS reached clinical use?", expectedIds: ["kb-iris-rollout"], maxRank: 3 },
  { kind: "supported", id: "iris-time-results", category: "supported-question", question: "What did the 200 clinician comparison measure?", expectedIds: ["kb-iris-comparison"], maxRank: 3 },
  { kind: "supported", id: "iris-survey", category: "supported-question", question: "Would clinicians recommend IRIS?", expectedIds: ["kb-iris-recommendation"], maxRank: 3 },
  { kind: "supported", id: "deployed-reranker", category: "supported-question", question: "Has he deployed a fine-tuned reranker?", expectedIds: ["kb-retrieval-reranking"], maxRank: 3 },
  { kind: "supported", id: "faira-assessment", category: "supported-question", question: "What was his role in the FAIRA risk assessment?", expectedIds: ["kb-iris-governance"], maxRank: 3 },
  { kind: "supported", id: "treasure-project", category: "supported-question", question: "What was Find the Treasure?", expectedIds: ["kb-product-treasure"], maxRank: 3 },
